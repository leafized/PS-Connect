	...
	public class PS3API
	{
		...
		public class ConsoleList
		{
			...
			private string strTraduction(string keyword)
			{
				...
				else if (sysLanguage == Lang.German)
				{
					...
					case "btnRefresh":
						...
						return result;
					case "errorSelect":
						text = "Select a console before you can connect!";
						result = text;
						return result;
					case "errorSelectTitle":
			...
			public bool Show()
			{
				...
				this.panel2.BackColor = Color.FromArgb(35, 35, 35);
				...
				this.panel3.BackColor = Color.FromArgb(35, 35, 35);
				...
				this.panel4.BackColor = Color.FromArgb(48, 48, 48);
				...
				this.button1.FlatAppearance.BorderColor = Color.FromArgb(35,35,35);
				...
				this.panel5.BackColor = Color.FromArgb(48, 48, 48);
				this.panel5.BackgroundImageLayout = ImageLayout.Stretch;
				this.panel5.ForeColor = Color.FromArgb(255,255,255);
				...
				this.btnConnect.BackColor = Color.FromArgb(48, 48, 48);
				this.btnConnect.ForeColor = Color.White;
				this.btnConnect.FlatStyle = FlatStyle.Flat;
				this.btnConnect.FlatAppearance.BorderColor = Color.FromArgb(22, 43, 80);
				...
				this.btnRefresh.BackColor = Color.FromArgb(48, 48, 48);
				this.btnRefresh.ForeColor = Color.DarkGray;
				this.btnRefresh.FlatStyle = FlatStyle.Flat;
				this.btnRefresh.FlatAppearance.BorderColor = Color.FromArgb(22, 43, 80);
				...
				this.listView.BackColor = Color.FromArgb(35,35,35);
				this.listView.ForeColor = Color.DarkGray;
				this.listView.Font = new Font("Microsoft Sans Serif", 9f, FontStyle.Regular, GraphicsUnit.Point, 0);
				this.listViewGroup.Header = "Console List";
				...
				this.formList.ForeColor = Color.FromArgb(255,255,255);
